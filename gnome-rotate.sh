...
if [[ $(dconf read /org/gnome/desktop/peripherals/touchpad/send-events) == "'enabled'" ]]; then
  touchpadEnabled=true
elif [[ $(dconf read /org/gnome/desktop/peripherals/touchpad/send-events) == "'disabled'" ]]; then
